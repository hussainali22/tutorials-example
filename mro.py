...
class mro_order(osv.osv):
        ...
        for order in self.browse(cr, uid, ids, context=context):
            ...
            if order.procurement_group_id:
                for procurement in order.procurement_group_id.procurement_ids:
                    print "-------------------------------procurement.move_ids--------",procurement.move_ids , "---------------",
                    ...
                    for move in procurement.move_ids:
                        print "====================move.location_dest_id.id",move.location_dest_id.id ,"===================order.asset_id.property_stock_asset.id", "--------------------------",order.asset_id.property_stock_asset.id
                        print "==============================================================",move
                    print "-----------------------------------------------------------------available_line_ids",available_line_ids
    ...
    def action_confirm(self, cr, uid, ids, context=None):        
        ...
        for order in self.browse(cr, uid, ids, context=context):
            ...
            print "-------------------------------------------------------------------",order.asset_id.property_stock_asset.id ,order.asset_id.property_stock_asset.name
